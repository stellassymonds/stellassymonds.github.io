...
![](media/pottery.png){fig-alt="Me with my handmade bowls" width="700"}
...
::: {layout-ncol="3"}
![](media/venice.png){alt="One of my recent loaves" fig-align="left" width="300"}

![](media/cafe.png){alt="Cinnamon rolls with extra cinnamon" fig-align="center" width="300"}

![](media/torbole.png){alt="Cinnamon rolls with extra cinnamon" fig-align="right" width="300"}
:::
